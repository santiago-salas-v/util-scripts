...
def fit_from_csv(file_name, conf_level=0.95):
    ...
    output_file_name = os.path.join(os.path.abspath(os.path.dirname(file_name)),
...
class MainForm(QtGui.QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.open.clicked.connect(partial(self.operate_on_file))
    ...
    def operate_on_file(form):
        ...
        if filename != '':
            ...
            msgBox.setText('Saved: ' + out_file_name)
